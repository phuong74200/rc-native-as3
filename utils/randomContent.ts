...
We'll be using the React Native CLI. Here we are using Xcode. The steps for the environment variables and Android Studio are documented in the [official docs](https://reactnative.dev/docs/environment-setup).

First, we'll create a new[ React Native project](https://www.waldo.com/blog/react-native-project-structure). Go to any directory in the terminal. Use the command npx react-native init <project-name> to create a new project.
...
![](https://assets-global.website-files.com/62cee6c92b9c3a6e6cab65e3/62e8465a668786ac0322fee7_622bab44b7cfc47e4b9980bc_npx.png)

Now we need to run the npx [react-native run-ios](https://www.waldo.com/blog/react-native-run-ios) command in another terminal. It will also open the basic app on the iOS emulator.

![](https://assets-global.website-files.com/62cee6c92b9c3a6e6cab65e3/62e8465a6687861fd622fee9_622bab5c9096380f4eb1f4b8_npx%2520react.png)`,
];
